<?php
   ...
   $conn = new mysqli($serverName, $dBUsername, $dBPassword, $dBName);
    ...
    else
    {
	    ...
	    $stmt = $conn->prepare("SELECT ID,UserName,Password,Address,City,State,ZipCode,PhoneNumber, Email FROM Contacts WHERE ID = ? AND UserName=? AND Password =? AND Address = ? AND City = ? AND State = ? AND ZipCode = ? AND PhoneNumber = ? AND Email = ?");
